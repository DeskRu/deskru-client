  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        _Card(title: 'Corporate enrollment', children: [
          const EnrollmentCard(variant: EnrollmentCardVariant.settingsCard),
        ]),
      ],
    ).marginOnly(bottom: _kListViewBottomMargin);
  }
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: 'О DeskRu', children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://deskru.ru/privacy');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://deskru.ru');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
