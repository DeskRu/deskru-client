...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Password", "Пароль"),
        ("Ready", "Готов"),
        ("Connected to DeskRu", "Подключен к DeskRu"),
        ("Connect to organization", "Подключить к организации"),
        ("Connected to", "Подключен к"),
        ("Token is required", "Введите код приглашения"),
        ("Invitation code", "Код приглашения"),
        ("Connecting...", "Подключение..."),
        ("Bad server response", "Неверный ответ сервера"),
        ("Unknown error", "Неизвестная ошибка"),
        ("Paste the invitation code your administrator sent you. The device will be added to the organization automatically.", "Вставьте код приглашения, который прислал администратор. Устройство будет автоматически добавлено в организацию."),
        ("Corporate connection", "Корпоративное подключение"),
        ("Connect this device to a corporate DeskRu account using the invitation code your IT administrator sent you.", "Подключите этот компьютер к корпоративному аккаунту DeskRu по коду приглашения от администратора."),
        ("Connect by code", "Ввести код приглашения"),
        ("Disconnect from organization", "Отвязать от организации"),
        ...
        ("Uninstall", "Удалить"),
        ("Update", "Обновить"),
        ("check_update_tip", "Проверка обновлений"),
        ("Enable", "Включить"),
        ("Disable", "Отключить"),
        ("Options", "Настройки"),
