...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Corporate enrollment", "Корпоративное подключение"),
        ("Enter invitation code", "Ввести код приглашения"),
        ("corporate_enrollment_description", "Подключите этот компьютер к корпоративному аккаунту DeskRu по коду приглашения от администратора."),
